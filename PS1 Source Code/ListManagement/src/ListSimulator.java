...
public class ListSimulator {
	 ...
	 */
	ListSimulator(TestType type, List list) {
	...
	private static void run(List lRandom, List lUp, List lDown){
	...
	static public void main(String[] args) {
		List lRandom, lUp, lDown;

		System.out.println("ArrayList");
		lRandom = new ArrayList(LISTSIZE);
		lUp = new ArrayList(LISTSIZE);
		lDown = new ArrayList(LISTSIZE);
		run(lRandom, lUp, lDown);

		/*
		System.out.println("MoveToFrontArrayList");
		lRandom = new MoveToFrontArrayList(LISTSIZE);
		lUp = new MoveToFrontArrayList(LISTSIZE);
		lDown = new MoveToFrontArrayList(LISTSIZE);
		run(lRandom, lUp, lDown);
		*/
		
		/*
		System.out.println("LinkedList");
		lRandom = new LinkedList();
		lUp = new LinkedList();
		lDown = new LinkedList();
		run(lRandom, lUp, lDown);
		*/
		
		/*
		System.out.println("MoveToFrontLinkedList");
		lRandom = new MoveToFrontLinkedList();
		lUp = new MoveToFrontLinkedList();
		lDown = new MoveToFrontLinkedList();
		run(lRandom, lUp, lDown);
		*/
		
		/*
		System.out.println("MyFastList");
		lRandom = new MyFastList();
		lUp = new MyFastList();
		lDown = new MyFastList();
		run(lRandom, lUp, lDown);
		*/
		
		/*
		System.out.println("MarkNotFoundList");
		lRandom = new MarkNotFoundList();
		lUp = new MarkNotFoundList();
		lDown = new MarkNotFoundList();
		run(lRandom, lUp, lDown);
		*/
	}
